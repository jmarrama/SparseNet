...
fprintf('------------------------------------')
fprintf('Starting basic statistics section...')
fprintf('------------------------------------')

fprintf('Creating feature detectors')
...
fprintf('Plotting a few natural image patches')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Computing feature detectors outputs')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Scatterplot of neighbouring pixels')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('plot one row of covariance matrix')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Power spectra experiments')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Computing 1st and 100th PCs from ten random samples ')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%do PCA
fprintf('  Computing PCA number '); writenum(t)
[V,E,D]=pca(X);
...
fprintf('Computing one whole PCA')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Synthesizing images using the PCA model')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Computing dimension reduction needed to downsample properly')
...
fprintf('Removing DC component')
X=removeDC(X);
fprintf('Doing PCA and whitening data')
[V,E,D]=pca(X);
Z=V(1:rdim,:)*X;


fprintf('Starting computation of some individual ICs.')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Synthesizing images using the ICA model')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Computing optimal sparseness measures') %Figure 7.6
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Analyzing tuning of ICA features')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Plot histograms of correlations of nonlinear transforms')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('-----------------------------------------')
fprintf('Starting ICA on variance-normalized data.')
...
fprintf('Variance-normalizing data')
...
fprintf('Starting computation of one independent subspace.  ')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Showing different combinations of ISA features.')
...
fprintf('Starting computation of whole ISA.')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Ordering subspaces according to sparseness.')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Synthesizing images using the ISA model')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fprintf('Analyzing tuning of ISA features')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Computing optimal parameters for all linear rfs in ISA')
...
fprintf('------------------------------------')
fprintf('Starting TOPOGRAPHIC ICA section...')
fprintf('------------------------------------')
...
%save('whitenedimages', 'Z', '-ascii')

fprintf('Starting topographic ICA. ')
...
fprintf('Synthesizing images using the TICA model')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('Analyzing tuning of TICA features')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fprintf('-----------------------------------------')
fprintf('Starting overcomplete basis section...')
fprintf('-----------------------------------------')
...
fprintf('Starting overcomplete basis estimation. ')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
